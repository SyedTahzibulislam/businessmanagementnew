...
Go-Down Stock  Unit	<select id="sellingunit"  class="form-control "  name="sellingunit"  required   style='width: 270px;'>
  ...
  <div class="row"> 
    ...
    <div class="col-4">
    Go-Down Stock :   <input type="text" class="form-control register_form " name="stock" id="stock" placeholder="stock" required  autocomplete="off" >
    </div>
    <div class="col-4">
...
<P>
			...
			<b style="color:red;"> Selling Unit and Unit Price:</b>
                <thead>
                    <tr>
